            ...
            <form action="#" class="form-horizontal" method="post" enctype="multipart/form-data" name="update_members">
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        <label for="deb_amount" class="form-label m-0 fw-normal">NIC Number <span
                                class="text-danger">*</span></label>
                        <input type="text" name="nic" id="cus_image" class="form-control pt-1 pb-1"
                            placeholder="Enter nic" required>
                    </div>
                    <div class="col-lg-6 mb-3">
                        <label for="customer_name" class="form-label m-0 fw-normal" style="font-size: 17px;">Customer Name <span
                                class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-6 mb-3">
                        <label for="customer_city" class="form-label m-0 fw-normal">Customer City <span
                                class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-12 mb-3">
                        <label for="customer_address" class="form-label m-0 fw-normal">Address <span
                                class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-6 mb-3">
                        <label for="customer_mobile" class="form-label m-0 fw-normal">Mobile Number (9477777777) <span
                                class="text-danger">*</span></label>
