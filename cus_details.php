                ...
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" name="customer_name" id="customer_name"
                            class="form-control pt-1 pb-1 bg-dark-subtle " readonly>
                    </div>
                    ...
                    <div class="col-lg-6 mb-3">
                        <label for="customer_status" class="form-label m-0 fw-normal" style="font-size:17px;">Credit
                            Status</label>
                        <input type="text" name="customer_type" id="customer_status"
                            class="form-control pt-1 pb-1 bg-dark-subtle " readonly>
                    </div>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input type="number" step="0.01" min="0" name="cre_amount"
                            class="form-control pt-1 pb-1 bg-dark-subtle " readonly>
                    </div>
                </div>
            </form>
